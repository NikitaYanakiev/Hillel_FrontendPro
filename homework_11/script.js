...
for (let i = 0; i < users.length; i++) {
    ...
    sumBalanceUsers += user.balance;
}

console.log('Номера телефонов пользователей у которых на счету больше 2000$:', richUsers);
console.log(`Cумма всех балансов пользователей: ${sumBalanceUsers}`);